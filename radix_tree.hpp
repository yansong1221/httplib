...
typedef std::tuple<bool, std::function<void(request &req, response &resp)>,
                   std::unordered_map<std::string, std::string>>
    parse_result;

typedef std::tuple<
    bool, std::function<net::awaitable<void>(request &req, response &resp)>,
    std::unordered_map<std::string, std::string>>
    coro_result;
...
struct radix_tree_node {
    ...
    std::function<void(request &req, response &resp)>
    ...
    int add_handler(std::function<void(request &req, response &resp)> handler,
