...
public:
    ...
    net::awaitable<void> send_event(std::string_view data,
    ...
    net::awaitable<void> send_retry(std::chrono::milliseconds ms) override
    {
        auto msg = "retry: " + std::to_string(ms.count()) + "\n\n";
        co_await cw_.write_chunk(std::move(msg));
    }

    net::awaitable<void> send_comment(std::string_view comment) override
    {
