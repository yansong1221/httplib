...
namespace httplib::body
{
    ...
    string_body::reader::reader(http::fields const&, value_type& b) : body_(b) {}

    void
    string_body::reader::init(boost::optional<std::uint64_t> const& length, beast::error_code& ec)
    {
        if (length)
        {
    ...
    string_body::writer::writer(http::fields const&, value_type const& b) : body_(b) {}
