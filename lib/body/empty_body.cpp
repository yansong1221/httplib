...
void empty_body::writer::init(beast::error_code& ec)
{
    ec = {};
}
...
void empty_body::reader::finish(beast::error_code& ec)
{
    ec = {};
}

void empty_body::reader::init(boost::optional<std::uint64_t> const&, beast::error_code& ec)
{
    ec = {};
}
