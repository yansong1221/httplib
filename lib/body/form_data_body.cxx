...
std::string form_data_body::writer::generate_boundary() {
...
boost::optional<std::pair<httplib::form_data_body::writer::const_buffers_type, bool>>
...
void form_data_body::reader::init(
    boost::optional<std::uint64_t> const &content_length,
    boost::system::error_code &ec) { // VFALCO We could reserve space in the file
