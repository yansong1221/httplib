...
boost::optional<std::pair<json_body::writer::const_buffers_type, bool>> json_body::writer::get(
...
void json_body::reader::init(boost::optional<std::uint64_t> const& content_length, boost::system::error_code& ec)
{
