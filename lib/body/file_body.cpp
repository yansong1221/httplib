...
void file_body::writer::init(boost::system::error_code& ec) { ec.clear(); }

boost::optional<std::pair<file_body::writer::const_buffers_type, bool>> file_body::writer::get(
...
void file_body::reader::init(boost::optional<std::uint64_t> const& content_length, boost::system::error_code& ec) { }

void file_body::reader::finish(boost::system::error_code& ec) { ec.clear(); }
