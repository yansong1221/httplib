...
namespace httplib::body
{
    ...
    file_body::writer::writer(http::fields const&, value_type& b) : body_(b) {}
    ...
    file_body::writer::get(boost::system::error_code& ec)
    {
        ...
        auto const& range = body_.ranges.at(*range_index_);
        switch (step_)
        {
            case step::header:
            {
    ...
    file_body::reader::reader(http::fields const&, value_type& b) : body_(b) {}

    void
    file_body::reader::init(boost::optional<std::uint64_t> const& content_length, boost::system::error_code& ec)
    {
    ...
    std::size_t
    file_body::reader::put(const_buffers_type const& buffers, boost::system::error_code& ec)
    {
        auto data = static_cast<char const*>(buffers.data());
