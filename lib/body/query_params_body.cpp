...
void
query_params_body::reader::init(boost::optional<std::uint64_t> const& content_length,
...
std::size_t
query_params_body::reader::put(net::const_buffer const& buffers,
                               boost::system::error_code& ec)
{
    ec = {};
...
query_params_body::reader::finish(boost::system::error_code& ec)
{
    ...
    if (!is_valid) { ec = http::error::unexpected_body; }
}
