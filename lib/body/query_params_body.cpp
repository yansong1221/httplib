...
query_params_body::writer::writer(const http::fields&, value_type const& body) : body_(body) { }
...
boost::optional<std::pair<query_params_body::writer::const_buffers_type, bool>> query_params_body::writer::get(
...
query_params_body::reader::reader(const http::fields&, value_type& body) : body_(body) { }

void query_params_body::reader::init(boost::optional<std::uint64_t> const& content_length,
                                     boost::system::error_code& ec)
{
    if (content_length) buffer_.reserve(*content_length);
    ec = {};
}

std::size_t query_params_body::reader::put(net::const_buffer const& buffers, boost::system::error_code& ec)
{
    ec = {};
