...
public:
    auto
    expires_after(const net::steady_timer::duration& expiry_time)
    {
        return std::visit(
            [&](auto& t) mutable {
    ...
    {
        return std::visit(
            [&](auto& t) mutable { return beast::get_lowest_layer(t).expires_never(); },
            *this);
    }
    ...
    rate_policy() & noexcept
    {
        return std::visit(
            [&](auto& t) mutable -> auto& {
                return beast::get_lowest_layer(t).rate_policy();
            },
            *this);
    }
    auto&
    ...
    {
        return std::visit(
            [&](auto& t) -> auto& { return beast::get_lowest_layer(t).rate_policy(); },
            *this);
    }
};
