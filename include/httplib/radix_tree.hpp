...
typedef std::tuple<bool, http_handler_type, std::unordered_map<std::string, std::string>>
    parse_result;
...
struct radix_tree_node {
    ...
    std::function<void(request &req, response &resp)> get_handler(const http::verb &method) {
    ...
    int add_handler(http_handler_type handler, const http::verb &method) {
...
public:
    ...
    int insert(const std::string &path, http_handler_type handler, const http::verb &method) {
        auto root = this->root;
    ...
    int coro_insert(const std::string &path, coro_http_handler_type coro_handler,
    ...
    parse_result get(const std::string &path, const http::verb &method) {
