...
protected:
    void set_http_handler(http::verb method, std::string_view key, coro_http_handler_type&& handler);
    void set_default_handler(coro_http_handler_type&& handler);
    void set_file_request_handler(coro_http_handler_type&& handler);
